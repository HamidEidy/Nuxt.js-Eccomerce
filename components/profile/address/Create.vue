<template>
    ...
    <div class="collapse mt-3" id="collapseExample">
        <FormKit id="createaddress" type="form" @submit="create" #default="{ value }" :incomplete-message="false"
            :actions="false">
            <div class="card card-body">
                ...
                <div class="row g-4">
                    ...
                    <div class="col col-md-6">
                        <FormKit type="text" name="postal_code" id="postal_code" label="کد پستی" label-class="form-label"
                            ...
                            :validation-messages="{ required: 'فیلد کدپستی الزامیست', 'matches': 'کد پستی 10 رقمی وارد کنید' }"
                            place-holder="d" messages-class="form-text text-danger" />
                    </div>
                    <div class="col col-md-6">
                ...
                <div>
                    <FormKit type="submit" input-class="btn mt-4">
                        ایجاد
                    </FormKit>
                </div>
            </div>
...
async function create(value) {
    try {
        ...
        errors.value = error.data.data.message.postal_code
    } finally {
        loading.value = false;
    }
}
